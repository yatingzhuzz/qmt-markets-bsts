...
analyze_bsts_mcmc_trace_plots <- function(all_evaluations, all_models, best_models) {
  ...
  pdf("MCMC_trace_plot_EW_ALL_2016Q4.pdf", width=12, height=10)
...
create_prediction_plots <- function(all_evaluations, all_models, extended_test_sets, hold_out_dataset) {
  library(ggplot2)
  pdf("Prediction_Distribution_EW_ALL_2016Q4.pdf", width = 12, height = 8)
...
format_window_range <- function(window) {
  train_ranges <- c(
    "1-70", 
    "1-82 (excluding hold-out 80-86)",
    "1-87 (excluding hold-out 80-86)",
    "1-92 (excluding hold-out 80-86)",
    "1-97 (excluding hold-out 80-86)"
  )
...
# Save the workbook
saveWorkbook(wb, file = "Removed_pre_BWEW_2016.xlsx", overwrite = TRUE)
...
analyze_bsts_mcmc_trace_plots <- function(all_evaluations, all_models, best_models) {
  # Create a PDF device to save all plots
  pdf("MCMC_trace_plot_EW_BW_2016Q4.pdf", width=12, height=10)
...
create_prediction_plots <- function(all_evaluations, all_models, extended_test_sets, hold_out_dataset) {
  library(ggplot2)
  pdf("Prediction_Distribution_EW_BW_2016Q4.pdf", width = 12, height = 8)
...
# Save the workbook
saveWorkbook(wb, file = "Removed_pre_StepEW_2016.xlsx", overwrite = TRUE)
...
analyze_bsts_mcmc_trace_plots <- function(all_evaluations, all_models, best_models) {
  # Create a PDF device to save all plots
  pdf("MCMC_trace_plot_EW_STEP_2016Q4.pdf", width=12, height=10)
...
create_prediction_plots <- function(all_evaluations, all_models, extended_test_sets_step, hold_out_dataset) {
  library(ggplot2)
  pdf("Prediction_Distribution_EW_Step_2016Q4.pdf", width = 12, height = 8)
...
create_excel_results_revised <- function(
  ...
  file_path <- "EW_Step_2016Q4.xlsx"  # CORRECT FILE NAME FOR STEPWISE
